CREATE TABLE autor(id_autor SERIAL PRIMARY KEY, nombre_autor VARCHAR(50) NOT NULL, primer_apellido VARCHAR(50) NOT NULL, segundo_apellido VARCHAR(50));
CREATE TABLE editorial(id_editorial SERIAL PRIMARY KEY, nombre_editorial VARCHAR(50) NOT NULL);
CREATE TABLE cliente(id_cliente SERIAL PRIMARY KEY, nombre_cliente VARCHAR(50) NOT NULL, ap_paterno VARCHAR(50) NOT NULL, ap_materno VARCHAR(50));
...
CREATE TABLE libro_editorial(codigo_libro INT NOT NULL REFERENCES libro (codigo_libro), id_editorial INT NOT NULL REFERENCES editorial (id_editorial));
